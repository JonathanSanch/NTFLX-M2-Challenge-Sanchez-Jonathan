...
//    API documented using OpenAPI (YAML)


    private List<User> userList;

//    Given data for API to use
//    Constructor for the Controller Class
    public ChatterbookController() {
//        Instantiation of User Objects & Sample Data
...
//      All ChatterPosts and their users
...
//    GET Route to return a single user by user name
    ...
    //    GET Route to return a list of chatterPosts for a user by user name
